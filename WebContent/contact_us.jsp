...
<div class="shell">
  ...
  <table width="57" border="0" style="float: left">
      ...
      <table width="380" border="0" style="float: left;">
          ...
          <tr>
              <td height="30"></td>
              <td height="30" style="color: blue; font-size: 16px">Pick up the phone and call us @8826935796</td>
          </tr>
          <tr>
              <td height="30"></td>
    ...
    <table width="57" border="0" style="float: left">
      ...
      <table width="280" border="0">
          ...
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">Ducat Noida</td>
          </tr>
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">Sector 16</td>
          </tr>
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">Delhi,UP</td>
          </tr>
      </table>
